...
//==================================================================
#ifndef LPRES_EXAMPLES__RL10_offDesign_performance2_H
#define LPRES_EXAMPLES__RL10_offDesign_performance2_H

#include <INTEG_simula.h>

class LPRES_EXAMPLES__RL10_offDesign_performance2: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	LPRES_EXAMPLES__RL10_offDesign_performance2(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static LPRES_EXAMPLES__RL10_offDesign_performance2* s_current;
public: 
