...
//==================================================================
#ifndef TRABAJO__RL10_offdesign_offdesign_partition_H
#define TRABAJO__RL10_offdesign_offdesign_partition_H

#include <INTEG_simula.h>

class TRABAJO__RL10_offdesign_offdesign_partition: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	TRABAJO__RL10_offdesign_offdesign_partition(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static TRABAJO__RL10_offdesign_offdesign_partition* s_current;
public: 
