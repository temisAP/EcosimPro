...
//==================================================================
#ifndef TRABAJO__RL10_design_partition_H
#define TRABAJO__RL10_design_partition_H

#include <INTEG_simula.h>

class TRABAJO__RL10_design_partition: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	TRABAJO__RL10_design_partition(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static TRABAJO__RL10_design_partition* s_current;
public: 
