...
//==================================================================
#ifndef TRABAJO__RL10_alternative_control_partition1_H
#define TRABAJO__RL10_alternative_control_partition1_H

#include <INTEG_simula.h>

class TRABAJO__RL10_alternative_control_partition1: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	TRABAJO__RL10_alternative_control_partition1(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static TRABAJO__RL10_alternative_control_partition1* s_current;
public: 
