...
//==================================================================
#ifndef TRABAJO__RL10_control_regulator_H
#define TRABAJO__RL10_control_regulator_H

#include <INTEG_simula.h>

class TRABAJO__RL10_control_regulator: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	TRABAJO__RL10_control_regulator(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static TRABAJO__RL10_control_regulator* s_current;
public: 
